...
# In order to provide most of the functionality of the Enumerable module you just need to include it within
# your class and then define an each method that yields each member of the collection one at a time.
